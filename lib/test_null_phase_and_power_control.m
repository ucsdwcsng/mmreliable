function [SNR_multi, SNR_single, SNR_oracle, wmulti, wsingle, woracle]= test_null_phase_and_power_control( beam, h, wannaplot)
...
[wmulti,bMulti] = get_null_multibeam_weights(beam.AOD,beam.amp,beam.phase,0);
